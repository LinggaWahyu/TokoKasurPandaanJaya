...
import com.equinox.controller.ControllerMasterTokoLangganan;
 ...
 * @author equinox
 */
public class MasterTokoLanggananForm extends javax.swing.JFrame {
    
    private ControllerMasterTokoLangganan controllerToko;
    
    public MasterTokoLanggananForm() {
        if (Session.getStatusLoginAdmin() == "AKTIF") {
            initComponents();
            setSize(466,609);
            setLocationRelativeTo(null);
            controllerToko = new ControllerMasterTokoLangganan(this);
            controllerToko.tampilanAwal();
        } else {
            dispose();
    ...
    public JTextField getTf_idToko() {
        return tf_idToko;
    }
    ...
    private void initComponents() {
        ...
        tf_idToko = new javax.swing.JTextField();
        ...
        lb_admin.setBounds(12, 12, 100, 18);
        ...
        lb_date.setBounds(310, 10, 150, 18);
        ...
        jLabel4.setBounds(30, 190, 70, 18);

        jLabel5.setFont(new java.awt.Font("Ubuntu", 1, 15)); // NOI18N
        jLabel5.setText("Alamat");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(30, 290, 70, 18);

        jLabel6.setFont(new java.awt.Font("Ubuntu", 1, 15)); // NOI18N
        jLabel6.setText("No. telp");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(30, 340, 80, 18);
        getContentPane().add(tf_idToko);
        tf_idToko.setBounds(120, 130, 184, 37);
        getContentPane().add(tf_nama);
        tf_nama.setBounds(120, 180, 184, 37);
        ...
        tf_alamat.setBounds(120, 280, 184, 37);
        getContentPane().add(tf_notelp);
        tf_notelp.setBounds(120, 330, 184, 37);
        ...
        tb_toko.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tb_tokoMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tb_toko);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(30, 380, 415, 140);

        jLabel2.setFont(new java.awt.Font("Ubuntu", 1, 15)); // NOI18N
        jLabel2.setText("Password");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(30, 240, 90, 18);
        getContentPane().add(tf_password);
        tf_password.setBounds(120, 230, 184, 37);
        ...
        bt_tambah.setBounds(330, 170, 110, 40);
        ...
        bt_hapus.setBounds(330, 210, 110, 40);
        ...
        bt_edit.setBounds(330, 250, 110, 40);
        ...
        bt_reset.setBounds(330, 290, 110, 40);
        ...
        bt_kembali.setBounds(340, 530, 106, 40);

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/equinox/view/image/8 asli.png"))); // NOI18N
        getContentPane().add(jLabel7);
        jLabel7.setBounds(-1, -3, 470, 580);
    ...
    private void tb_tokoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tb_tokoMouseClicked
        controllerToko.getDataField();
        controllerToko.setKomponen("clicked");
    }//GEN-LAST:event_tb_tokoMouseClicked

    private void bt_tambahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bt_tambahMouseClicked
        controllerToko.insert();
        controllerToko.isiTabel();
        controllerToko.tampilanAwal();
        controllerToko.reset();
        controllerToko.setKomponen("added");
    ...
    private void bt_hapusMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bt_hapusMouseClicked
        controllerToko.hapus();
        controllerToko.isiTabel();
        controllerToko.reset();
        controllerToko.setKomponen("deleted");
    ...
    private void bt_editMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bt_editMouseClicked
        controllerToko.update();
        controllerToko.isiTabel();
        controllerToko.reset();
        controllerToko.setKomponen("edited");
    ...
    private void bt_resetMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bt_resetMouseClicked
        controllerToko.tampilanAwal();
        controllerToko.reset();
        controllerToko.setKomponen("reseted");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MasterTokoLanggananForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField tf_idToko;
